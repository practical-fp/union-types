...
describe("match2", () => {
    ...
    it("should infer the correct types", () => {
        const result = match2(mkBar(42), mkBar(1337))
            .with(Foo, unknown, (value1, value2) => {
                assert<IsExact<typeof value1, Foo>>(true)
                assert<IsExact<typeof value2, Union>>(true)
                return 1 as const
            })
            .with(unknown, Foo, (value1, value2) => {
                assert<IsExact<typeof value1, Union>>(true)
                assert<IsExact<typeof value2, Foo>>(true)
                return 2 as const
            })
            .done((value1, value2) => {
                assert<IsExact<typeof value1, Union>>(true)
...
describe("match3", () => {
    ...
    it("should infer the correct types", () => {
        const result = match3(mkBar(42), mkBar(1337), mkBar(69))
            .with(Foo, unknown, unknown, (value1, value2, value3) => {
                assert<IsExact<typeof value1, Foo>>(true)
                assert<IsExact<typeof value2, Union>>(true)
                assert<IsExact<typeof value3, Union>>(true)
                return 1 as const
            })
            .with(unknown, Foo, unknown, (value1, value2, value3) => {
                assert<IsExact<typeof value1, Union>>(true)
                assert<IsExact<typeof value2, Foo>>(true)
                assert<IsExact<typeof value3, Union>>(true)
                return 2 as const
            })
            .with(unknown, unknown, Foo, (value1, value2, value3) => {
                assert<IsExact<typeof value1, Union>>(true)
                assert<IsExact<typeof value2, Union>>(true)
                assert<IsExact<typeof value3, Foo>>(true)
                return 3 as const
            })
            .done((value1, value2, value3) => {
                assert<IsExact<typeof value1, Union>>(true)
                assert<IsExact<typeof value2, Union>>(true)
                assert<IsExact<typeof value3, Union>>(true)
                return 4 as const
...
describe("match4", () => {
    ...
    it("should infer the correct types", () => {
        const result = match4(mkBar(42), mkBar(1337), mkBar(69), mkBar(-1))
            .with(Foo, unknown, unknown, unknown, (value1, value2, value3, value4) => {
                assert<IsExact<typeof value1, Foo>>(true)
                assert<IsExact<typeof value2, Union>>(true)
                assert<IsExact<typeof value3, Union>>(true)
                assert<IsExact<typeof value4, Union>>(true)
                return 1 as const
            })
            .with(unknown, Foo, unknown, unknown, (value1, value2, value3, value4) => {
                assert<IsExact<typeof value1, Union>>(true)
                assert<IsExact<typeof value2, Foo>>(true)
                assert<IsExact<typeof value3, Union>>(true)
                assert<IsExact<typeof value4, Union>>(true)
            ...
            .with(unknown, unknown, Foo, unknown, (value1, value2, value3, value4) => {
                assert<IsExact<typeof value1, Union>>(true)
                assert<IsExact<typeof value2, Union>>(true)
                assert<IsExact<typeof value3, Foo>>(true)
                assert<IsExact<typeof value4, Union>>(true)
            ...
            .with(unknown, unknown, unknown, Foo, (value1, value2, value3, value4) => {
                assert<IsExact<typeof value1, Union>>(true)
                assert<IsExact<typeof value2, Union>>(true)
                assert<IsExact<typeof value3, Union>>(true)
                assert<IsExact<typeof value4, Foo>>(true)
                return 4 as const
            })
            .done((value1, value2, value3, value4) => {
                assert<IsExact<typeof value1, Union>>(true)
                assert<IsExact<typeof value2, Union>>(true)
                assert<IsExact<typeof value3, Union>>(true)
                assert<IsExact<typeof value4, Union>>(true)
